...
public class HelpPageTest {
    ...
    private HelpPage helpPage1 = new HelpPage(myTitle1, myDesc1, id1);
    private HelpPage helpPage2 = new HelpPage(myTitle2, myDesc2, id2);
    private HelpPage sameAsHelpPage1 = new HelpPage(new String(myTitle1), new String(myDesc1), id1);
    ...
    public void getIdReturnsCorrectId() {
        assertEquals(id1, helpPage1.getId());
    }

...
public class PointOfInterestActivity extends BasicActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void configureToolBar(){
        this.toolbar = findViewById(R.id.poi_activity_toolbar);
        setSupportActionBar(toolbar);
    }

    private void configureDrawerLayout(){
        this.drawerLayout = findViewById(R.id.poi_activity_drawer_layout);
    ...
    private void configureNavigationView(){
        this.navigationView = findViewById(R.id.poi_activity_nav_view);
